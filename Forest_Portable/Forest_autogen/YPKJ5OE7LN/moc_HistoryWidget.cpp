...
#include "../../../src/ui/HistoryWidget.h"
...
static constexpr auto qt_meta_stringdata_CLASSHistoryWidgetENDCLASS = QtMocHelpers::stringData(
    "HistoryWidget"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSHistoryWidgetENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSHistoryWidgetENDCLASS_t qt_meta_stringdata_CLASSHistoryWidgetENDCLASS = {
    {
        QT_MOC_LITERAL(0, 13)   // "HistoryWidget"
    },
    "HistoryWidget"
};
